...
```
docker run --gpus 1 --device=/dev/dri:rw -it -e TZ=UTC -e SIZEW=1920 -e SIZEH=1080 -e CDEPTH=24 -e SHARED=TRUE -e PASSWD=mypasswd -p 8080:8080 ehfd/nvidia-egl-desktop:latest
```
